    ...
    <div class="p-2">
        ...
        <div class="text-slate-500 flex justify-between">
            ...
            <div>
                ...
                <form action="{{ route('items.update_stock', $item->id) }}" method="POST" class="mb-3 hidden" id="form-update-stock">
                    @csrf
                    <input type="number" name="stock" id="stock" value="{{ $item->stock }}" class="w-12 rounded p-1">
                    <div class="mt-2">
