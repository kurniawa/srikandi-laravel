    ...
    @endfor --}}
        ...
        <form action="{{ route('items.update', $item->id) }}" method="POST">
                ...
                <div class="grid grid-cols-2 gap-2">
                    <div class="">
                        <label for="tipe_barang" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">tipe
                            barang</label>
                        <input type="text" id="tipe_barang" name="tipe_barang" value="{{ $item->tipe_barang }}" readonly
                    ...
                    <div class="mb-5">
                        @if (old('tipe_perhiasan'))
                            <label id="label_jenis_perhiasan" for="jenis_perhiasan"
                                ...
                                {{ old('tipe_perhiasan') }}</label>
                        @else
                            <label id="label_jenis_perhiasan" for="jenis_perhiasan"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">jenis
                                {{ $item->tipe_perhiasan }}</label>
                        @endif
                        ...
                        @else
                            <input type="text" name="jenis_perhiasan" id="jenis_perhiasan"
                                value="{{ $item->jenis_perhiasan }}" onchange="generateNama()"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        @endif
                    </div>
                    <div class="mb-5">
                                ...
                                @if (old('kondisi'))
                                    @foreach ($obj_kondisi as $kondisi)
                                        @if (old('kondisi') == $kondisi['value'])
                                            <option value="{{ $kondisi['value'] }}" selected>{{ $kondisi['label'] }}
                                            </option>
                                        @else
                        ...
                        <div class="mb-3">
                            ...
                            @if (old('cap'))
                                <input type="text" id="cap" name="cap" value="{{ old('cap') }}"
                                    ...
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            @else
                                <input type="text" id="cap" name="cap" value="{{ $item->cap }}"
                                    onchange="generateNama()"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            @endif
                        </div>
                        ...
                        <div id="div_plat" class="mb-3 hidden">
                            ...
                            @if (old('plat'))
                                <input type="number" step="1" max="9" min="0" id="plat"
                                    name="plat" value="{{ old('plat') }}" onchange="generateNama()"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            @else
                                <input type="number" step="1" max="9" min="0" id="plat"
                                    name="plat" value="{{ $item->plat }}" onchange="generateNama()"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            @endif
                        </div>
                    </div>
                                                    ...
                                                    @if (old("level_warna.$key"))
                                                        @foreach ($arr_level_warnas as $level_warna)
                                                            @if (old("level_warna.$key") == $level_warna)
                                                                <option value="{{ $level_warna }}" selected>
                                                                    {{ $level_warna }}</option>
                                                            @else
                                                                <option value="{{ $level_warna }}">{{ $level_warna }}
                                                                </option>
                                                            @endif
                                                        @endforeach
                                                    @else
                                        ...
                                        <div class="mb-1">
                                            <select id="level_warna" name="level_warna[]"
                                                ...
                                                @if (old('level_warna.0'))
                                                    @foreach ($arr_level_warnas as $level_warna)
                                                        @if (old('level_warna.0') == $level_warna)
                                                            <option value="{{ $level_warna }}" selected>
                                                                {{ $level_warna }}</option>
                                                        @else
                                                            <option value="{{ $level_warna }}">{{ $level_warna }}
            ...
            <div class="text-center mt-10">
                <button type="submit" class="bg-emerald-300 text-white px-3 py-2 rounded font-bold">Konfirmasi
                    Edit</button>
            </div>
        </form>
