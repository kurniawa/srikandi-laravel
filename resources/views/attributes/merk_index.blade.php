...
<main class="p-2">
    ...
    <div class="flex justify-between items-center">
        ...
        <button id="btn-toggle-new-merk" class="border-2 border-emerald-300 rounded-lg text-emerald-300" onclick="toggle_light(this.id, 'div-new-merk', [], ['bg-emerald-200'], 'block')">
    ...
    {{-- NEW MERK --}}
    <div id="div-new-merk" class="hidden mt-2 border rounded p-1">
        <form action="{{ route('attributes.merks.store') }}" method="POST">
            ...
            <div class="flex justify-center mt-2">
                <div class="rounded p-2 bg-emerald-300 text-white font-bold">
                    <button type="submit">Konfirmasi +Tambah Merk</button>
                </div>
            </div>
        </form>
    </div>
