...
<main class="p-2">
    ...
    <form method="POST" action="{{ route('pelanggans.store', $user->id) }}" class="p-5 border rounded bg-white shadow drop-shadow mt-2">
        @csrf
        <div class="">
            ...
            <input
                ...
                id="displayName"
                name="nama"
                placeholder="Aldebaran Al Fahri"
        ...
        <div class="mt-5 text-center">
            <button
                type="submit"
                class="loading-spinner bg-emerald-300 rounded text-white font-bold px-3 py-2 hover:bg-emerald-400 disabled:opacity-25"
