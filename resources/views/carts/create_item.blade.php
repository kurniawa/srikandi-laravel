...
<main>
    ...
    <form action="{{ route('items.store', $from) }}" method="POST">
        ...
        <div class="p-2">
            <div class="grid grid-cols-2 gap-2">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="jenis_perhiasan" id="jenis_perhiasan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>
                <div class="mb-5">
                ...
                <div class="mb-5">
                    ...
                    <select id="warna_emas" name="warna_emas" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            <div class="grid grid-cols-2 gap-2">
                <div class="mb-5">
                    ...
                    <input type="text" id="kadar_formatted" onchange="formatNumber(this, 'kadar')" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="berat_formatted" onchange="formatNumber(this, 'berat')" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="harga_gr_formatted" onchange="formatNumber(this, 'harga_gr')" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="harga_t_formatted" onchange="formatNumber(this, 'harga_t')" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <input type="hidden" id="harga_t" name="harga_t">
                </div>
            </div>
            <div class="mb-5">
                <label id="label_nama" for="nama" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">nama</label>
            ...
            <div class="border border-indigo-300 p-2 rounded">
                ...
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="cap" name="cap" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                    <div class="mb-3">
                        <label for="range_usia" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">range_usia</label>
                        <select id="range_usia" name="range_usia" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    ...
                    <div id="div_plat" class="mb-3 hidden">
                        ...
                        <input type="text" id="plat" name="plat" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                </div>
                    ...
                    <div id="data_mata">
                        <div id="data-mata-0" class="data-mata">
                            <div class="grid grid-cols-2 gap-2 mt-2 border-t border-b border-violet-300 p-1">
                                ...
                                <div class="mb-1">
                                    <select id="tingkat_warna" name="tingkat_warna[]" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <div id="div_mainan" class="mt-2 hidden">
                    ...
                    <div id="data_mainan">
                        <div id="data-mainan-0" class="data-mainan">
                            ...
                            <div class="flex justify-end mt-1">
                                <button class="bg-pink-300 text-white px-2 py-1 rounded-2xl" onclick="removeElement('data-mainan-0')">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-6 h-6">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14" />
                                    </svg>
                                </button>
        ...
        <div class="text-center mt-5">
            <button class="bg-emerald-300 text-white px-3 py-2 rounded font-bold">+ Tambah Item Baru</button>
        </div>
    </form>
</main>
...
<script>
    ...
    function addMata() {
        ...
        `<div id="data-mata-${index_mata}">
            ...
            <div class="flex justify-end mt-1">
                <button class="bg-pink-300 text-white px-2 py-1 rounded-2xl" onclick="removeMata('data-mata-${index_mata}')">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14" />
                    </svg>
                </button>
    ...
    function addMainan() {
        ...
        `<div id="data-mainan-${index_mainan}" class="data-mainan">
            ...
            <div class="flex justify-end mt-1">
                <button class="bg-pink-300 text-white px-2 py-1 rounded-2xl" onclick="removeElement('data-mainan-${index_mainan}')">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14" />
                    </svg>
                </button>
