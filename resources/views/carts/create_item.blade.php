        ...
        <form action="{{ route('items.store') }}" method="POST">
            ...
            <div class="p-2">
                ...
                <div class="mb-5 border border-emerald-300 rounded p-1">
                    ...
                    <input type="text" id="nama_short" name="nama_short"
                        value="{{ old('nama_short') ? old('nama_short') : '' }}"
            ...
            <div class="text-center mt-10">
                <button type="submit" class="loading-spinner bg-emerald-300 text-white px-3 py-2 rounded font-bold">+
