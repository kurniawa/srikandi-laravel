...
<main class="p-2">
    ...
    <div class="flex gap-2 border p-2 rounded mt-5">
        ...
        <a href="{{ route('add_new_item.create', ['CREATE_NEW', 'perhiasan', 0]) }}" class="loading-spinner bg-emerald-400 text-white px-2 py-1 rounded">perhiasan</a>
        <a href="{{ route('add_new_item.create', ['CREATE_NEW', 'LM', 0]) }}" class="loading-spinner bg-emerald-400 text-white px-2 py-1 rounded">LM</a>
    </div>
