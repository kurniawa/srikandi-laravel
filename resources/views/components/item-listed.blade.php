<div class="relative">
    ...
    @if ($suratpembelianitem->status_buyback == 'buyback')
    <div class="absolute top-0 bottom-0 left-0 right-0 bg-slate-300 opacity-50 z-30"></div>
    ...
    <div class="grid grid-cols-12 border-y py-3">
        ...
        <div class="col-span-9 flex justify-between relative z-10">
            <div>
