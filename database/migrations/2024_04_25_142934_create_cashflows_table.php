...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('cashflows', function (Blueprint $table) {
            ...
            $table->string('kode_accounting'); // Untuk mengidentifikasi Accounting yang terkait dengan cashflow ini
            $table->foreignId('surat_pembelian_id')->nullable()->constrained()->onDelete('cascade'); // nullable karena pemasukan bisa jadi belum tentu dari pembelian item perhiasan
