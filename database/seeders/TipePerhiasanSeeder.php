...
class TipePerhiasanSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        //     if (preg_match('/4/', (string)$barcode)) {
        ...
        // Path ke file JSON
        $path = storage_path('backup/tipe_perhiasans.json');
        ...
        if (!empty($data)) {
            DB::table('tipe_perhiasans')->insert($data);
            $this->command->info('Data berhasil dimasukkan ke tabel tipe_perhiasans.');
        } else {
